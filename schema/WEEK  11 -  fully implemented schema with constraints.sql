...
-- 1. Show record counts for all tables
SELECT 
    table_name AS 'Table', 
...
WHERE 
    TABLE_SCHEMA = 'InventoryDB' 
ORDER BY 
    table_name;

-- 2. Sample data from each table (5 rows each)
-- Users
SELECT 'Users Sample' AS description;
SELECT * FROM Users LIMIT 5;

-- Suppliers
SELECT 'Suppliers Sample' AS description;
SELECT supplier_id, name, contact FROM Suppliers LIMIT 5;

-- Customers
SELECT 'Customers Sample' AS description;
SELECT customer_id, name, loyalty_points FROM Customers LIMIT 5;

-- Categories
SELECT 'Categories Sample' AS description;
SELECT * FROM Categories;

-- Products
SELECT 'Products Sample' AS description;
SELECT product_id, name, stock_quantity, price FROM Products 
ORDER BY product_id LIMIT 5;

-- Discounts
SELECT 'Discounts Sample' AS description;
SELECT discount_id, product_id, discount_percentage, is_active 
FROM Discounts LIMIT 5;

-- Orders
SELECT 'Orders Sample' AS description;
SELECT order_id, order_number, status, total_amount 
FROM Orders LIMIT 5;

-- OrderItems
SELECT 'OrderItems Sample' AS description;
SELECT order_item_id, order_id, product_id, quantity 
FROM OrderItems LIMIT 5;

-- StockTransactions
SELECT 'StockTransactions Sample' AS description;
SELECT transaction_id, product_id, transaction_type, quantity 
FROM StockTransactions 
ORDER BY transaction_id DESC LIMIT 5;

-- AuditLog
SELECT 'AuditLog Sample' AS description;
SELECT log_id, action_type, table_name, timestamp 
FROM AuditLog 
